package com.davimesquita.notificacao.Business;

import com.davimesquita.notificacao.Business.DTO.TarefasDTO;
import com.davimesquita.notificacao.Infrastructure.Exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try {
            ...
            throw new EmailException("Erro : Não foi possível enviar o email ", e.getCause());
        }
